...
pub const SYS_DELEGATE_CALL: u32 = 0x208;
...
pub fn block_height() -> u64 {
    let lo = unsafe { ecall(SYS_BLOCK_HEIGHT, 0, 0, 0, 0) };
    // Block height fits in u32 for a very long time, but return as u64 for consistency
    lo as u64
}
...
pub fn block_timestamp() -> u64 {
    let lo = unsafe { ecall(SYS_BLOCK_TIMESTAMP, 0, 0, 0, 0) };
    lo as u64
}

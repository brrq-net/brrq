...
impl FederationManager {
    ...
    pub fn new(
        ...
        let unique_count = initial_members
            ...
            .len();
        // In dev-mode, allow single-member federation (1-of-1) for testnet.
        // Production builds enforce MIN_FEDERATION_SIZE=3, MIN_THRESHOLD=2.
        let (min_size, min_thresh) = if cfg!(feature = "dev-mode") {
            (1, 1)
        } else {
            (MIN_FEDERATION_SIZE, MIN_THRESHOLD)
        };
        if unique_count < min_size {
